...
describe('InventoryItemEditModal', () => {
  it('renders category select options and preserves unknown current values', async () => {
    ...
    expect(onSave).toHaveBeenCalledWith(7, expect.objectContaining({ itemCategory: 'Metals' }));
  });
});